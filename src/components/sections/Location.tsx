...
import { useScrollAnimation, useMapsDirections } from '@/lib/utils';
          ...
          <div>
            <div className="mb-8">
              ...
              <div className="flex items-start gap-3 text-gray-600">
                <svg className="w-6 h-6 text-gold shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
